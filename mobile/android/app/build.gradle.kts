...
android {
    namespace = "com.scammer.ia.scammer_mobile"
    compileSdk = flutter.compileSdkVersion
    ndkVersion = "27.0.12077973"

    compileOptions {
        // Requerido por flutter_local_notifications (usa java.time en minSdk bajos)
    ...
    defaultConfig {
        ...
        // record (grabacion por microfono) requiere min SDK 23
